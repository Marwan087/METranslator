...
2. **شغل المثبت (Run the Installer):**
...
3. **ابدأ التطبيق:**
   بمجرد التثبيت، قم تشغيل `METranslator.exe` أو اختصار سطح المكتب.

4. **الإعداد في التطبيق:**
...
**رابط المشروع:** [https://github.com/yourusername/METranslator](https://github.com/yourusername/METranslator)
